...
class LaundryAddDialog : DialogFragment() {
    private val vm by viewModel<LaundryAddDialogViewModel>()

    private lateinit var binding: DialogAddLaundryBinding
    private lateinit var _context: Context

    private lateinit var adapter: LaundryAddRecyclerViewAdapter
    ...
    override fun onCreateView(
        ...
        adapter = LaundryAddRecyclerViewAdapter()
